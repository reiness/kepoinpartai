...
<head>
    ...
    <title>kepoin partai | Gelora</title>
</head>
<body>
@extends('layouts.app')
...
<section>
    <div class="container" style="padding-top: 120px;">
        <img class = "logo-partai"src="{{ asset('images/image_7.png') }}" alt="logo partai" >
        <h1 style="margin-bottom: 20px; color: #5038bc; font-weight: bold">Partai Gelombang Rakyat Indonesia.</h1>

        <div class="card" style=" border-radius: 20px">
        <h3>Ketua umum: {{ $profile_gelora -> ketua_umum }}</h3>
        </div>
