...
<head>
    ...
    <title>kepoin partai | Gerindra</title>
</head>
<body>
@extends('layouts.app')
...
<section>
    <div class="container" style="padding-top: 120px;">
        <img class = "logo-partai"src="{{ asset('images/image_2.png') }}" alt="logo partai" >
        <h1 style="margin-bottom: 20px; color: #5038bc; font-weight: bold">Gerindra.</h1>
        ...
        <div class="card" style=" border-radius: 20px">
            ...
            <p>Total Kasus: {{ $profile_gerindra -> jumlah_kasus_korupsi }}</p>
            <p>Total Kerugian Negara: {{ $profile_gerindra -> nominal_kasus_korupsi }} Miliar</p>
        </div>
