...
<head>
    ...
    <title>kepoin partai | NasDem</title>
</head>
<body>
@extends('layouts.app')
...
<section>
    <div class="container" style="padding-top: 120px;">
        <img class = "logo-partai"src="{{ asset('images/image_5.png') }}" alt="logo partai" >
        <h1 style="margin-bottom: 20px; color: #5038bc; font-weight: bold">Partai Nasional Demokrat.</h1>

        <div class="card" style=" border-radius: 20px">
        <h3>Ketua umum: {{ $profile_NasDem -> ketua_umum }}</h3>
        </div>
        ...
        <div class="card" style=" border-radius: 20px">
            ...
            <p>Total Kasus: {{ $profile_NasDem -> jumlah_kasus_korupsi }}</p>
            <p>Total Kerugian Negara: {{ $profile_NasDem -> nominal_kasus_korupsi }} Miliar</p>
        </div>
