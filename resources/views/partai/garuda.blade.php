...
<head>
    ...
    <title>kepoin partai | garuda</title>
</head>
<body>
@extends('layouts.app')
...
<section>
    <div class="container" style="padding-top: 120px;">
        <img class = "logo-partai"src="{{ asset('images/image_11.png') }}" alt="logo partai" >
        <h1 style="margin-bottom: 20px; color: #5038bc; font-weight: bold">Garuda.</h1>

        <div class="card" style=" border-radius: 20px">
        <h3>Ketua umum: {{ $profile_garuda -> ketua_umum }}</h3>
        </div>
