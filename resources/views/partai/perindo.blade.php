...
<head>
    ...
    <title>kepoin partai | Perindo</title>
</head>
<body>
@extends('layouts.app')
...
<section>
    <div class="container" style="padding-top: 120px;">
        <img class = "logo-partai"src="{{ asset('images/image_16.png') }}" alt="logo partai" >
        <h1 style="margin-bottom: 20px; color: #5038bc; font-weight: bold">Persatuan Indonesia.</h1>

        <div class="card" style=" border-radius: 20px">
        <h4>Ketua umum: {{ $profile_perindo -> ketua_umum }}</h4>
        </div>

        <div class="card" style=" border-radius: 20px">
            <h3 style="color: #5038bc;font-weight: medium">Kasus Korupsi</h3>
            <p>Total Kasus: {{ $profile_perindo -> jumlah_kasus_korupsi }}</p>
            <p>Total Kerugian Negara: {{ $profile_perindo -> nominal_kasus_korupsi }} Miliar</p>
        </div>
